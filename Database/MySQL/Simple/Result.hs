...
convertException :: [Field]
             ...
             -> ResultError
convertException fs vs n = ConversionFailed
...
-- | Throw a 'ConversionFailed' exception as generated by 'convertException'.
convertError
  :: [Field]
  -> [Maybe ByteString]
  -> Int
  -> a
convertError as bs n = throw $ convertException as bs n
